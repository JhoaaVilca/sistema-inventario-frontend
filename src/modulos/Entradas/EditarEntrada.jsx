...
function EditarEntrada({ show, handleClose, entrada, onEntradaEditada, inlineMode = false }) {
    ...
    // Formulario reutilizable para modo inline y para usarse dentro del Modal
    const Formulario = (
        <>
            {errorMsg && (
            ...
            <div className="mt-3">
                <strong>
                    Total de la Entrada: S/{productosEntrada
                ...
                <div className="col-md-4 d-flex align-items-end">
                    {archivoFactura && (
                        <div className="d-flex gap-2">
                            ...
                            >
                                <X size={16} className="me-1" /> Quitar
                            </Button>
                        </div>
                    )}
                </div>
                ...
                <div className="mt-3 p-3 bg-light rounded border">
                    <div className="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <br />
                            <small className="text-muted">{(archivoFactura.size / 1024 / 1024).toFixed(2)} MB</small>
                        </div>
                    </div>
                </div>
            )}
